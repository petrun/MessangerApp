...
class Validator {
    ...
    var validations = ValidatorDictionary<ValidationRule>()
    ...
    */
    ...
    - returns: No return value.
    */
    func validateField(_ field: ValidatableField, callback: (_ error: ValidationError?) -> Void) {
    ...
    */
    ...
    /**
     ...
     - returns: No return value
     */
    func registerField(_ field: ValidatableField, errorLabel: UILabel? = nil, rules: [Rule]) {
    ...
    /**
     ...
     - returns: No return value
     */
//    func unregisterField(_ field: ValidatableField) {
...
//    }
    ...
    /**
     ...
     - returns: No return value.
     */
    func validate(_ callback:(_ errors: [(Validatable, ValidationError)]) -> Void) {
        self.validateAllFields()
